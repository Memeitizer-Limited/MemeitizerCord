...
export default new class Settings {
     ...
     */
    save():void{
        return electron.ipcRenderer.sendSync("MEMEITIZERCORD_SAVE_SETTINGS")
    }
     ...
     */
    get settings():any{
        return electron.ipcRenderer.sendSync("MEMEITIZERCORD_GET_SETTINGS")
    }
     ...
     * @example ```js
     * const isTabs = MemeitizerCord.Api.settings.get("isTabs", false)
     * ```
     */
    ...
    set<Value>(key:string, value:Value):void{
        return electron.ipcRenderer.sendSync("MEMEITIZERCORD_SET_SETTING", key, value)
    }
    ...
    delete(key:string):void{
        return electron.ipcRenderer.sendSync("MEMEITIZERCORD_DELETE_SETTING", key)
    }
